...
class ErrorBoundary extends Component<{ children: ReactNode }, { error: Error | null }> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ padding: 32, fontFamily: "monospace", whiteSpace: "pre-wrap", background: "#fee", color: "#900", border: "2px solid #c00", margin: 16, borderRadius: 8 }}>
          <strong>RENDER ERROR (dev only — remove ErrorBoundary when fixed)</strong>{"\n\n"}
